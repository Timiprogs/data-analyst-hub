...
function About() {
  return (
    <div className="bg-white m-20 p-10 text-blue-900 ">
      <h1 className="font-bold text-4xl mb-8 text-center">About Us</h1>

      <h2 className="font-bold text-3xl mb-4 text-center">
        Vision and Mission
      </h2>
      <p className="font-sans text-xl border-solid border-2 p-4 border-indigo-600 rounded-lg my-7">
      ...
      <img
        className=" xs:h-[300px] bg block w-full h-[600px] rounded-lg "
        src={data}
        alt=""
      />
      ...
      <h2 className="font-bold text-3xl m-8 text-center"> Our Team </h2>
      <p className="font-sans p-4 text-xl border-solid border-2 border-indigo-600 rounded-lg">
      ...
      <h2 className="font-bold text-3xl m-8 text-center">
        Client Success Stories
      </h2>
      <p className="font-sans p-4 odd:text-xl border-solid border-2 border-indigo-600 rounded-lg">
